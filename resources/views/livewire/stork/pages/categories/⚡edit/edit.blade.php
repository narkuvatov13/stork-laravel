<div>
    {{-- Categories Heading --}}
    <div class="mb-6">
        <h1 class="text-2xl font-bold dark:text-slate-100 text-zinc-900"> Category Edit</h1>
    ...
    <div class="bg-white  rounded-lg border border-slate-200 p-6">
        <form wire:submit.prevent="update" class='space-y-6'>
            ...
            <div class="">
                ...
                <input type="text" id='name' wire:model='name' placeholder='Enter Category Name' autofocus
            ...
            @isset($existing_image)
                <div class="mt-3" wire:transition>
                    <img src=@if ($image) "{{ $image->temporaryUrl() }}" @else {{ asset('storage/' . $existing_image) }} @endif
                        class="h-32 w-auto rounded border border-slate-300" alt="Preview">
                </div>
            @endisset ($image)
